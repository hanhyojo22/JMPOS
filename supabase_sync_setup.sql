...
add column if not exists receipt_discount_amount numeric,
add column if not exists receipt_discount_type text,
add column if not exists receipt_discount_value numeric,
add column if not exists original_price numeric,
add column if not exists product_discount_percent numeric,
add column if not exists product_discount_amount numeric,
